...
class Employee(models.Model):
    ...
    empl_role = models.CharField(max_length=10)  # 'Manager' або 'Cashier'
...
class Product(models.Model):
    ...
    category_number = models.ForeignKey(
        Category, on_delete=models.DO_NOTHING, db_column='category_number'
    )
...
class Store_Product(models.Model):
    ...
    id_product = models.ForeignKey(
        Product, on_delete=models.DO_NOTHING, db_column='id_product'
    )
...
class Chek(models.Model):
    ...
    id_employee = models.ForeignKey(
        Employee, on_delete=models.DO_NOTHING, db_column='id_employee'
    )
...
class Sale(models.Model):
    UPC = models.ForeignKey(
        Store_Product, on_delete=models.DO_NOTHING, db_column='UPC'
    )
    check_number = models.ForeignKey(
        Chek, on_delete=models.CASCADE, db_column='check_number'
    )
